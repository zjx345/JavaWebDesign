...
<div class="firstPage">
    ...
    <div class="head">
        ...
        <div class="header">
            ...
            <!--登录-->
            <div class="username">
                <a href="www.baidu.com">${sessionScope.SESSION_USER.name}</a>
            </div>
            <div class="exit">
            ...
            <div class="bigGuide">
                ...
                <div class="guideLeft">
                    <dl>
                        ...
                        <dd><div><a href="/musicCategroyServlet">&nbsp;&nbsp;&nbsp;榜单&nbsp;&nbsp;&nbsp;</a></div></dd>
        ...
        <div class="loginArea">
            ...
            <form>
                ...
                <input class="login_identity user" type="radio" name="identity" checked="checked">用户
                <input class="login_identity admin" type="radio" name="identity">管理员<br>
            ...
            <div class="xgsf_left_content">
                ...
                <div class="musicName">
                    <div>
                            ...
                            <a href="/playServlet?id=1"><span>${sessionScope.SESSION_ALL_MUSIC.get(0).name}</span>
                            <span class="flag">
									<!--<i class="fa fa-play"></i>
                    ...
                    <div>
                        <a href="/playServlet?id=2"><span>${sessionScope.SESSION_ALL_MUSIC.get(1).name}</span>
                            <span class="time">02:30</span></a>
                    </div>
                    <div>
                        <a href="/playServlet?id=3"><span>${sessionScope.SESSION_ALL_MUSIC.get(2).name}</span>
                            <span class="time">04:52</span></a>
                    </div>
                    <div>
                        <a href="/playServlet?id=4"><span>${sessionScope.SESSION_ALL_MUSIC.get(3).name}</span>
                            <span class="time">03:22</span></a>
                    </div>
                    <div>
                        <a href="/playServlet?id=5"><span>${sessionScope.SESSION_ALL_MUSIC.get(4).name}</span>
                            <span class="time">02:44</span></a>
                    </div>
                    <div>
                        <a href="/playServlet?id=6"><span>${sessionScope.SESSION_ALL_MUSIC.get(5).name}</span>
                            <span class="time">02:34</span></a>
                    </div>
                    <div>
                        <a href="/playServlet?id=7"><span>${sessionScope.SESSION_ALL_MUSIC.get(6).name}</span>
                            <span class="time">02:30</span></a>
                    </div>
                    <div>
                        <a href="/playServlet?id=8"><span>${sessionScope.SESSION_ALL_MUSIC.get(7).name}</span>
