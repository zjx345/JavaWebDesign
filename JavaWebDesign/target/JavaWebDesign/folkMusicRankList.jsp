    ...
    <div class="rankList">
        ...
        <div class="title">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active" href="folkMusicRankList.jsp">民谣</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="chineseMusicRankList.jsp">华语</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="eaMusicRankList.jsp">欧美</a>
                </li>
                <li class="nav-item">
        ...
        <div class="content">
            <table class="table table-hover">
                <c:forEach items="${sessionScope.SESSION_FOLK_MUSIC}" var="music" varStatus="id">
                    <tr>
                        <td>
                            <a href="/playServlet?id=${music.id}"><span>${music.name}</span></a><span class="time">04:27</span><a href="/downloadMusicServlet?url=${music.url}"><i class="fa fa-download"></i></a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
